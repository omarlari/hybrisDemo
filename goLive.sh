...
AWS_INSTANCE_DNSNAME=$(curl -u reader:e8f8922efce5f8d861504a1131ce4f2a -s "10.99.254.83/job/hybrisGetIp/lastSuccessfulBuild/consoleText" | grep IPADDRESS | tail -n 1 | cut -d: -f2 | cut -c 11-)
