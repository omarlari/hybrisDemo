...
PUBLICIP=$(aws ec2 describe-instances --instance-id $INSTANCEID --region us-west-2 --query 'Reservations[].Instances[].NetworkInterfaces[].PublicIpAddress' --output text)
